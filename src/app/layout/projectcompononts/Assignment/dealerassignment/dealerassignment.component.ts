...
@Component({
  selector: 'app-dealerassignment',
  templateUrl: './dealerassignment.component.html',
  styleUrls: ['./dealerassignment.component.css']
})
export class DealerassignmentComponent implements OnInit {
  ...
  distibutorText:string; devicelistText:string; 

  ListOfDistributor$:Object; ListOfDevicetype$:Object; ListOfDevicelist$:Object; ListOfDealer$:Object;
  ...
  EncryptPageName() {
    this.cryptService.encrypt("Dealer Assignment Entry")
