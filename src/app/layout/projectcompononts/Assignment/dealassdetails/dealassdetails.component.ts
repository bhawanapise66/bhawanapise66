...
@Component({
  selector: 'app-dealassdetails',
  templateUrl: './dealassdetails.component.html',
  styleUrls: ['./dealassdetails.component.css']
})
export class DealassdetailsComponent implements OnInit {
  encryptedpageNameValue: string;
  encryptedpageUrlValue: string;

  key: string = 'name'; reverse: boolean = true; config: any;  
  viewcount:string;  count:string;
  
  pageUrl = this.router.url;

  public loading = false; p: number;   pagecount:number; filter:string;

  
  dealerText:string; devicedetypeText:string;  devicelistText:string; remark_:string;
  noof_device:string; cust_name:string; mobile_no:string; deleteText:string;

  ListOfDistributor$:Object; ListOfDevicetype$:Object; ListOfDevicelist$:Object; ListOfDealer$:Object; PlaceOrderDetails$:Object;
...
/* ------------------------------- Wizards end Ts------------------------------------------------- */
  ...
  EncryptPageName() {
    this.cryptService.encrypt("Dealer Assign Details")
    ...
    this.listService.DealerListAPI(keydata).subscribe(
      (data)  => {
       ...
       let resdatalist = data.entity.list; 
        ...
        let dealerlist = resdatalist;
      
        this.ListOfDealer$ = dealerlist;
...
setdata(com ){
  ...
  //  this.ven_name =  vendordatadetails.param3;
  //  this.short_code = vendordatadetails.param4;
  //  this.vendor_cin = vendordatadetails.param9;
  //  this.vendor_gst = vendordatadetails.param10;
  //  this.off_no = vendordatadetails.param17; 
  //  this.off_email = vendordatadetails.param13;
  //  this.con_name = vendordatadetails.param15;
  //  this.con_email = vendordatadetails.param16;
  //  this.con_mobno = vendordatadetails.param18;
  //  this.ven_state = vendordatadetails.param8;
  //  this.ven_city = vendordatadetails.param7;
  //  this.reg_add = vendordatadetails.param5;
  //  this.pin_code = vendordatadetails.param12;
  //  this.bank_acc = vendordatadetails.param21;
  //  this.bank_name = vendordatadetails.param22;
  //  this.bank_ifsc = vendordatadetails.param23;
  //  this.bank_add = vendordatadetails.param24;
