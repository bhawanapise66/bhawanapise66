...
@Component({
  selector: 'app-employeemappdetails',
  templateUrl: './employeemappdetails.component.html',
  styleUrls: ['./employeemappdetails.component.css']
})
export class EmployeemappdetailsComponent implements OnInit {
  ...
  RemarkupdateText:string; submitted=false;
...
/* ------------------------------- Wizards end Ts------------------------------------------------- */
  ...
  //  console.log("p" + this.p);
    ...
    try{AddLoader()}catch(e){alert(e)} 
     ...
     this.employeedevicemappingService.EmployeeDepartmentDeviceDetailsAPI(keydata).subscribe(
      (data)  => {
...
/*------------------Search End ---------------------*/
deviceid:string; deviceimei:string; deviceunique:string;  employeename:string; customermobile:string;  customerpincode:string;
designation:string; department:string;Employeeid:string;
setdata(com){
  // alert(com);
   this.backdetailsbtn();
   let empdatadetails = com;
   this.Employeeid = empdatadetails.param2;
   this.deviceid =  empdatadetails.param3;
   this.deviceimei = empdatadetails.param12;
   this.deviceunique = empdatadetails.param13;
   this.employeename = empdatadetails.param6;
...
//  console.log("p" + this.p);
 ...
 { 
  ...
  DeviceEntry(){
    this.router.navigate(['./EMPLOYEEmappingentry']);
     ...
     this.submitted = true;
      // var divisiondata = $('#divisiondummy').val();
       ...
       if(!devicedata && devicedata.length <= 0){
         ...
         this.employeedevicemappingService.Changedevicetoemployee(dataL).subscribe((data)=>{
