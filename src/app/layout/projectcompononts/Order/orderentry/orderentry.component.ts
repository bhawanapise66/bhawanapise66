...
@Component({
  ...
  styleUrls: ['./orderentry.component.css']
})
export class OrderentryComponent implements OnInit {
  ...
  noOfdeviceentryText:string; mobilenoentryText:string; remarkText:string; datafromrespo:string;
  ...
  EncryptPageName() {
    this.cryptService.encrypt("Order Entry")
  ...
  vensavebtn(){
    $('#noofdeviceentry').focus();
      ...
      //  $('#msg_Officialemail').html('').hide();
         var isValid = true; 
         var noofdevicenew = $('#noofdeviceentry').val();
         var mobnonew = $('#Mobnoentry').val();
        
         var Remarknew = $('#Remarkentry').val();
         var officialemail = $('#officialEmail').val();
         // Validate Vendor Name
         if(!noofdevicenew && noofdevicenew.length <= 0){
           isValid = false;
           $('#msg_errorentry').html('Please Enter Device No').show();
           $('#noofdeviceentry').focus();
         }else 
         if(!mobnonew && mobnonew.length <= 0){
          // validate short code
           isValid = false;
          ...
          let dataL = {
            param1:"",
            param2:"",
            param3:this.noOfdeviceentryText, 
            param4:this.mobilenoentryText, 
             pageID: "7",
             pageName: this.encryptedpageNameValue,
             pageURL: this.encryptedpageUrlValue
              }
          this.placeodrService.InsertplaceorderAPI(dataL).subscribe((data)=>{
          //  alert(dataL);
          //  alert(data);
