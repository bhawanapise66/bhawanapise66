...
const URLV3 = 'https://track.indtrack.com/vtsweb/';
...
export class DevicemasterService {
  ...
  DeviceDetailsAPI(param) {
    ...
    return this.http.post<any>(URL + 'devicedetails_forvehicleinstall', myObjStr, httpOptions)

  }


  RequestedDeviceDetails(param) {
    const myObjStr = JSON.stringify(param);
    var httpOptions = {
      headers: new HttpHeaders({
        'HeaderKey': sessionStorage.getItem('hk'),
    ...
    return this.http.post<any>(URLV3 + 'requesteddevicedetails', myObjStr, httpOptions)
