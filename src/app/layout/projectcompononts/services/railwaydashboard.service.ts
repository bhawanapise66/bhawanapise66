...
export class RailwaydashboardService {

  constructor(private http: HttpClient) { }

  RailwayDashboardCountAPI(param) {
    ...
    return this.http.post<any>(URL + 'railwaysdashboardcount', myObjStr, httpOptions)
  ...
  GetGeofenceDetailsformap(param) {
    ...
    return this.http.post<any>(URL + 'processlivealert', myObjStr, httpOptions)

  }

  GetHistoryprogressalerts(param) {
    ...
    return this.http.post<any>(URL + 'processhistoryalert', myObjStr, httpOptions)

  }


  GetLiveprogressalerts(param) {
    //track.indtrack.com/vtsindtrackapitest
  ...
  GetFilterStatus(param) {
    ...
    return this.http.post<any>(URL + 'filterstatus', myObjStr, httpOptions)
