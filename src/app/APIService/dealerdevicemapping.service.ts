...
export class DealerdevicemappingService {


 
  constructor(private http: HttpClient) { }

  Assigndevicetodealer(param) {
    ...
    return this.http.post<any>(URL + 'assigndevicetodealer', myObjStr, httpOptions)
  }


  DealerDeviceMappingDetailsAPI(param) {
    const myObjStr = JSON.stringify(param);
    var httpOptions = {
      headers: new HttpHeaders({
        'HeaderKey': sessionStorage.getItem('hk'),
  ...
  DealerUnassignDeviceDetailsAPI(param) {
    const myObjStr = JSON.stringify(param);
    var httpOptions = {
      headers: new HttpHeaders({
        'HeaderKey': sessionStorage.getItem('hk'),
    ...
    return this.http.post<any>(URL + 'unassigndevicefromdealer', myObjStr, httpOptions)
  }
