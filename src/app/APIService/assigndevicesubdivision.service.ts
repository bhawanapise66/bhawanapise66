...
export class AssigndevicesubdivisionService {

  constructor(private http: HttpClient) { }

  AssigndevicetoSubDivision(param) {
    ...
    return this.http.post<any>(URL + 'assigndevicetosubdivision', myObjStr, httpOptions)
  }

  SubDivisionDeviceDetailsAPI(param) {
    const myObjStr = JSON.stringify(param);
    var httpOptions = {
      headers: new HttpHeaders({
        'HeaderKey': sessionStorage.getItem('hk'),
    ...
    return this.http.post<any>(URL + 'subdivisiondevicedetails', myObjStr, httpOptions)
  }

  SubDivisionDeviceUpdateAPI(param) {
    const myObjStr = JSON.stringify(param);
    var httpOptions = {
      headers: new HttpHeaders({
        'HeaderKey': sessionStorage.getItem('hk'),
    ...
    return this.http.post<any>(URL + 'changedevicefromsubdivision', myObjStr, httpOptions)
  }

  UnassignSubDivisionDeviceUpdateAPI(param) {
    const myObjStr = JSON.stringify(param);
    var httpOptions = {
      headers: new HttpHeaders({
        'HeaderKey': sessionStorage.getItem('hk'),
    ...
    return this.http.post<any>(URL + 'unassigndevicefromsubdivision', myObjStr, httpOptions)
  }
}
