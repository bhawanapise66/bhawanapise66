...
export class PlaceodrmodelService {

  constructor(private http: HttpClient) { }

  InsertplaceorderAPI(param){
    ...
    return this.http.post<any>(URL + 'insertorder', myObjStr, httpOptions) 
   }
   PlaceOrderDetailsAPI(param){
    const myObjStr = JSON.stringify(param);
    var httpOptions = {
      headers: new HttpHeaders({
        'HeaderKey': sessionStorage.getItem('hk'),
    ...
    return this.http.post<any>(URL + 'orderdetails', myObjStr, httpOptions) 
   }
   UpdateplaceorderAPI(param){
    const myObjStr = JSON.stringify(param);
    var httpOptions = {
      headers: new HttpHeaders({
        'HeaderKey': sessionStorage.getItem('hk'),
    ...
    return this.http.post<any>(URL + 'updateorder', myObjStr, httpOptions) 
   }
   DeleteVendorAPI(param){
    ...
    return this.http.post<any>(URL + 'deleteorder', myObjStr, httpOptions) 
   }
}
