...
Date      	: 23-10-2020
Description : Device Model Api Service 
...
export class DevicemodelService {
  ...
  InsertdevicemodelAPI(param) {
    ...
    return this.http.post<any>(URL + 'insertmodel', myObjStr, httpOptions)
  }

  UpdatedevicemodelAPI(param) {
    const myObjStr = JSON.stringify(param);
    var httpOptions = {
      headers: new HttpHeaders({
        'HeaderKey': sessionStorage.getItem('hk'),
    ...
    return this.http.post<any>(URLV3 + 'updatemodel', myObjStr, httpOptions)
  }

   DeleteModelAPI(param) {
    const myObjStr = JSON.stringify(param);
    var httpOptions = {
      headers: new HttpHeaders({
        'HeaderKey': sessionStorage.getItem('hk'),
    ...
    return this.http.post<any>(URLV3 + 'deletemodel', myObjStr, httpOptions)
  }

  DeviceModelDetailsAPI(param) {
    const myObjStr = JSON.stringify(param);
    var httpOptions = {
      headers: new HttpHeaders({
        'HeaderKey': sessionStorage.getItem('hk'),
    ...
    return this.http.post<any>(URL + 'modeldetails', myObjStr, httpOptions)
  }
