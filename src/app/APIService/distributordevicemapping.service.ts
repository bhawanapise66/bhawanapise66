...
export class DistributordevicemappingService {

 
  constructor(private http: HttpClient) { }

  Assigndevicetodistributor(param) {
    ...
    return this.http.post<any>(URL + 'assigndevicetodistributor', myObjStr, httpOptions)
  }


  DistributorDeviceMappingDetailsAPI(param) {
    const myObjStr = JSON.stringify(param);
    var httpOptions = {
      headers: new HttpHeaders({
        'HeaderKey': sessionStorage.getItem('hk'),
  ...
  DistributorUnassignDeviceDetailsAPI(param) {
    const myObjStr = JSON.stringify(param);
    ...
    return this.http.post<any>(URL + 'unassigndevicefromdistributor', myObjStr, httpOptions)
  }
